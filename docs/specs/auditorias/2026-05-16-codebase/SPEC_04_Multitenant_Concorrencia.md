...
**Status:** 🗄️ histórico — auditoria aplicada · **Escopo:** `dependencies`, `core/middleware`, `core/llm_guard`, `core/redis_pool`, `core/cache`, `core/embeddings` · **Severidade:** Alta para escalar além de 5 usuários ativos
