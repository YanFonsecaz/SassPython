...
**Status:** ✅ implementado · **Escopo:** `workflow_inlinks_reversos.py` (apenas `node_filtrar_similaridade` + pequenos ajustes em pseudo-conteúdo) · **Crédito:** mantém política atual
