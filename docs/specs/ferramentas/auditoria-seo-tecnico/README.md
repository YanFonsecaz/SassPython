...
**Estado:** 🚧 em desenvolvimento (Onda 1 implementada — upload manual + motor parcial: 31 regras de 98 itens SF; restantes na Onda 1b) · **Rota:** `/ferramentas/auditoria-seo-tecnico` · **Slug:** `auditoria_seo_tecnico`
