...
**Status:** ✅ implementado · **Escopo:** UI Next.js (página, componentes, hooks) + 1 nova dep (`recharts` via shadcn chart) · **Backend:** consome endpoints já especificados em [[SPEC_Ferramenta_Core_Web_Vitals]]
