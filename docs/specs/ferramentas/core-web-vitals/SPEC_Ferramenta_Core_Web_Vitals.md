...
**Status:** ✅ implementado · **Escopo:** backend (novo workflow + agentes + rota + worker + 2 tabelas novas) + frontend (formulário + dashboard histórico) + cobrança · **Crédito:** modelo por URL analisada
