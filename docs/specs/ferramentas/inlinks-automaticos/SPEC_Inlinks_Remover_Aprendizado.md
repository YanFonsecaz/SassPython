...
**Status:** ✅ implementado · **Escopo:** backend + frontend + 1 migration · **Crédito:** não muda · **Depende de:** `SPEC_Inlinks_Arquitetura_IA.md` + `SPEC_Inlinks_Refinamentos_UX.md` aplicadas
