...
class CwvProblemaConsolidado(Base, UUIDPrimaryKeyMixin):
    ...
    audit_ids: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
    problemas_origem_ids: Mapped[list] = mapped_column(JSONB, nullable=False, server_default="[]")
